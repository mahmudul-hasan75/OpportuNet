  ...
  return (
    <div className='min-h-screen'>
                ...
                {companyData && (
                    <div className='flex items-center gap-3'>
                        ...
                        <div className='relative group'>
                            ...
                            <div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black rouned pt-12'>
                                <ul className='list-none m-0 p-2 bg-white rounded-md border text-sm'>
                                    <li onClick={logout} className='py-1 px-2 cusor-pointer pr-10'>Logout</li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div className='flex items-start'>
            ...
            {/* Left Sidebar for options concerning jobs*/}
